...
# changes i can create it in above are as follow
...
# the changes i can create it is convert this line in to next new line# def totalcompanies(token: str = Depends(OAuth2PasswordBearer(tokenUrl="/token"))):
def totalcompanies(token: str = Depends(oauth2_scheme)):
...
# the changes i can create it is convert this line in to next new line# def companiesinlossfind(token: str = Depends(OAuth2PasswordBearer(tokenUrl="/token"))):
def companiesinlossfind(token: str = Depends(oauth2_scheme)):
