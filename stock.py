...
fig = px.line(data, x='Date',y=data.columns,title='closing price of the stock market', width=1000, height=600)
st.plotly_chart(fig)

# add a selectbow to select data from columns
column = st.selectbox('select the columns to be used for forcasting', data.columns[1:])
